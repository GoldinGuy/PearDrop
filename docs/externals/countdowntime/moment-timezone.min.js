!(function (t, e) {
	...
	function n(t) {
		var n = 0,
			...
			f = 0,
			a = 1;
		for (45 === t.charCodeAt(0) && ((n = 1), (a = -1)), n; n < r.length; n++)
			f = 60 * f + e(r.charCodeAt(n));
		for (n = 0; n < s.length; n++) (i /= 60), (f += e(s.charCodeAt(n)) * i);
		return f * a;
	}
	function o(t) {
	...
	function c(t, e) {
		for (var n, o; (o = 6e4 * (((e.at - t.at) / 12e4) | 0)); )
			(n = new a(new Date(t.at + o))).offset === t.offset ? (t = n) : (e = n);
		return t;
	}
	function h() {
		var t,
			...
			r = new a(new Date(o, 0, 1)),
			s = [r];
		for (n = 1; n < 48; n++)
			(e = new a(new Date(o, n, 1))).offset !== r.offset &&
				((t = c(r, e)), s.push(t), s.push(new a(new Date(t.at + 6e4)))),
				(r = e);
		for (n = 0; n < 4; n++)
			s.push(new a(new Date(o + n, 0, 1))),
				s.push(new a(new Date(o + n, 6, 1)));
		return s;
	}
	function l(t, e) {
	...
	function p(t, e) {
		var n, r;
		for (o(e), n = 0; n < e.length; n++)
			(r = e[n]), (x[r] = x[r] || {}), (x[r][t] = !0);
	}
	function d(t) {
		var e,
			n,
		...
		for (e = 0; e < r; e++) {
			o = x[t[e].offset] || {};
			for (n in o) o.hasOwnProperty(n) && (s[n] = !0);
		}
		for (e in s) s.hasOwnProperty(e) && i.push(D[e]);
		return i;
	}
	function m() {
		try {
		...
		for (o = 0; o < f.length; o++) {
			for (n = new u(b(f[o]), i), r = 0; r < i; r++) n.scoreOffsetAt(s[r]);
			a.push(n);
		}
	...
	function b(t, e) {
		...
		return o instanceof f
			...
			? ((o = new f(o)), (M[t] = o), o)
			: j[t] && e !== b && (n = b(j[t], b))
			? ((o = M[t] = new f())._set(n), (o.name = D[t]), o)
			: null;
	}
	function g(t) {
		var e, n, o, r;
	...
	function S(e) {
		...
		return (
			r && !t.isMoment(e) && w(s) && s.add(r.parse(s), "minutes"), s.tz(o), s
		);
	}
	function O(t) {
		return function () {
	...
	(Z < 2 || (2 === Z && F < 6)) &&
		...
		(f.prototype = {
			...
			parse: function (t) {
				...
				for (r = 0; r < a; r++)
					if (
						...
						(n = i[r + 1]),
						(o = i[r ? r - 1 : r]),
						e < n && S.moveAmbiguousForward
							? (e = n)
							: e > o && S.moveInvalidForward && (e = o),
						s < f[r] - 6e4 * e)
					)
						return i[r];
				return i[a];
			...
			offset: function (t) {
				return (
					y("zone.offset has been deprecated in favor of zone.utcOffset"),
		...
		(u.prototype.scoreOffsetAt = function (t) {
		...
		(S.link = g),
		(S.load = function (t) {
			z(t.zones), g(t.links), (S.dataVersion = t.version);
		}),
		(S.zone = b),
		(S.zoneExists = _),
		(S.guess = function (t) {
		...
		(S.names = function () {
			var t,
				e = [];
			for (t in D)
				D.hasOwnProperty(t) && (M[t] || M[j[t]]) && D[t] && e.push(D[t]);
			return e.sort();
		}),
		(S.Zone = f),
		(S.unpack = i),
	...
	(t.tz = S),
		...
		(t.updateOffset = function (e, n) {
			...
			void 0 === e._z &&
				(r &&
					w(e) &&
					!e._isUTC &&
					((e._d = t.utc(e._a)._d), e.utc().add(r.parse(e), "minutes")),
				(e._z = r)),
				e._z &&
					((o = e._z.utcOffset(e)),
					Math.abs(o) < 16 && (o /= 60),
					void 0 !== e.utcOffset ? e.utcOffset(-o, n) : e.zone(o, n));
		}),
		(k.tz = function (e, n) {
			return e
				? ((this._z = b(e)),
		...
		(k.zoneName = O(k.zoneName)),
		(k.zoneAbbr = O(k.zoneAbbr)),
		(k.utc = (function (t) {
			return function () {
